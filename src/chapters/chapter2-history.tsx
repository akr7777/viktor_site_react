...
const historyText2: string = `В годы Великой Отечественной войны Спиридонов, будучи инвалидом первой группы подготавливал бойцов ОМСБОН НКВД СССР
для боевой работы в тылу врага.
<br><br>
...
<br><br>\n\n\n\n\n
Система Спиридонова является культурным наследием Советской Эпохи и изучается в клубе «Спиридонов», как народное культурное достояние и часть нашей
истории, способствует воспитанию всесторонне многогранной развитой личности.`
